            ...
            "23_fields": {
                "basic": {
                    ...
                    "fields": {
                        ...
                        "policy_ref": {"name": "法律依据", "format": "法条编号+条文，必须引用现行有效版本，逐条对照repealed_law_watch核查是否废止/被替代。policy_ref末尾强制附法规现行性核验日期（格式：法规现行性核验：YYYY-MM-DD）。", "example": "《中华人民共和国增值税法》（2026-01-01施行）第十七条：销售额…（法规现行性核验：2026-07-13）"},
