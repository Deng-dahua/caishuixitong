...
=== 政策引用标准（铁律） ===
税务税务合规以现行有效法律法规为唯一引用依据。以下政策映射为系统强制规则：
...
【规则三十：禁止数据截断——全部信息完整呈现】
  ...
  ⑥ 资金流往来方→全部列示，废除TOP限制
  铁律：宁可报告长，不可漏一字。税务税务合规不放过任何一个细节。
...
【规则三十一：报告通用方法论标准（2026-06-24 老邓亲授）】
  ...
  - WHY：这是税务税务合规的"最小完整信息集"——回答谁、什么东西、多少数量、多少钱、什么时候、什么票种
...
═════ 前端页面体系（2026-06-30 补录）═════
  ...
  【文档模块（5个）】
  税务税务合规员手册 / 报告编制要求 / 审核内容模板 / 全链路质量保障体系 / AI行为准则
...
═════ 系统文件关联清单（2026-06-30）═════
  ...
  static/js/tax-auditor-handbook.js（税务税务合规员手册·12章）
