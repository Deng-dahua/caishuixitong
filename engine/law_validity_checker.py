...
DEPRECATED_LAWS: Dict[str, Tuple[str, str, str]] = {
    # ── 增值税 ──
    "增值税暂行条例": ("中华人民共和国增值税法", "2024.1.1", "原条例全文废止"),
    "中华人民共和国增值税暂行条例": ("中华人民共和国增值税法", "2024.1.1", "原条例全文废止"),
    "增值税暂行条例实施细则": ("中华人民共和国增值税法实施条例", "2024.1.1", "原细则全文废止"),
    "增值税条例": ("中华人民共和国增值税法", "2024.1.1", ""),
    "增值税法": ("中华人民共和国增值税法", "2024.1.1", "全称规范化"),
