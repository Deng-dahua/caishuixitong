...
COMMON_FACT_CONTRACTS = {
    ...
    "COMMON-PRODUCTION-SUBSTANCE": {
        "name": "生产经营实质与能源消耗核验",
        "rule_ids": {"VR014"},
        "target_fact": "登记为生产制造的企业，其进项中是否具备与生产规模相匹配的生产用能源（电、水、燃气、蒸汽）采购，以及是否有真实的生产场地、设备和人员支撑其经营实质。",
        "lead": "存货物流与生产经营域",
        "supporting": ["生产用能源采购发票", "厂房租赁或产权资料", "设备及产能资料", "水电燃气缴费凭证", "生产记录及考勤"],
        "opposing": ["生产外包或外购成品", "房东代收能源费用", "自备发电或新能源", "资料未上传或归集口径不同", "停产、转产或试生产"],
        "steps": ["统计生产用能源采购金额与生产经营采购规模", "连接厂房、设备、人员与产能资料", "核验委外加工或外购成品解释", "对能源缺口取得合理说明"],
    },
    "COMMON-SUPPLY-CHAIN-PENETRATION": {
        "name": "供应商地域分布与购销集中度核验",
        "rule_ids": {"VR016", "VR017"},
