...
SCENE_REWRITE_ROUTING = {
    "AGR-01": ("农产品销售收入", "土地种植成本", "种植基地面积", "苗木销售", "农业投入产出"),
    "AGR-02": ("自产农产品", "农林牧渔免税", "免税销售收入", "免税销售额", "自产经营场地"),
    "AGR-03": ("农产品收购", "收购发票", "农户备案", "农产品抵扣", "核定扣除"),
    "AGR-04": ("农民专业合作社", "合作社成员", "成员交易", "订单农业", "盈余返还"),
    "AGR-05": ("土地场地付款", "土地经营权", "土地流转", "集体土地", "农业经营用途"),
    "AGR-06": ("财政补贴", "财政性资金", "政府补助", "政府收储", "农业保险", "保险赔款", "不征税收入"),
    "AGR-07": ("生物资产", "存栏", "出栏", "繁育", "转群", "死亡毁损", "无害化"),
    "AGR-08": ("农产品初加工", "农产品深加工", "免税项目进项", "自产货物", "冷链损耗"),
    "MIN-01": ("矿业权", "采矿许可证", "矿区", "储量", "核定产能", "自然资源监测开采"),
    "MIN-02": ("原矿", "选矿", "精矿", "尾矿", "品位", "选矿回收率", "采选投入产出"),
    "MIN-03": ("资源税", "应税矿产品", "原矿选矿", "外购矿产品扣减", "运杂费扣除", "衰竭期矿山"),
    "MIN-04": ("外包采掘", "采掘外包", "剥离工程", "井巷工程", "矿内运输", "勘探外包", "矿山设备租赁"),
    "MIN-05": ("矿产品品位", "矿产品定价", "煤炭单价", "精矿计价", "关联销售", "化验结算"),
    "MIN-06": ("矿业权出让收益", "探矿权", "采矿权转让", "矿业权变更", "勘查开发投入"),
    "MIN-07": ("矿山安全生产费用", "矿区生态修复", "闭坑义务", "尾矿库修复", "矿山固体废物", "特殊工种"),
    "MIN-08": ("矿产品过磅", "矿产品运输", "地磅", "矿产品吨位", "港口堆存", "矿产品签收"),
    ...
    "PLT-01": ("涉税信息报送", "平台域名", "运营主体", "报送主体", "平台基本信息"),
    "PLT-02": ("实名认证", "账户实名", "经营者身份", "从业人员身份", "收款主体"),
    "PLT-03": ("平台交易流水", "平台结算", "平台订单", "佣金收入", "平台服务费"),
    "PLT-04": ("平台自营", "撮合", "主要责任人", "平台角色", "总额法", "净额法"),
    "PLT-05": ("网络直播", "直播平台", "主播", "虚拟币", "虚拟礼物", "打赏", "MCN"),
    "PLT-06": ("灵活用工", "任务订单", "平台从业人员", "劳务报酬", "代办申报", "众包"),
    "PLT-07": ("网络货运", "货运平台", "运输订单", "车辆轨迹", "实际承运人", "运单"),
    "PLT-08": ("境外平台", "跨境平台", "跨境服务", "境外经营者", "外币结算", "数字服务"),
}
