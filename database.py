...
def _classify_purchase_debit(db, company_id, inv):
    ...
    # 主营业务成本明细科目（640101~ 序号从01开始）
    _MAIN_BIZ_COST_DETAIL = {
        "广告服务":     ("640101", "广告服务成本"),
        "设计服务":     ("640102", "设计服务成本"),
        "信息技术服务": ("640103", "信息技术服务成本"),
        "现代服务":     ("640104", "现代服务成本"),
    }

    CATEGORY_ACCOUNT_MAP = {
        # === 主营业务成本 ===
        "广告服务":     ("640101", "主营业务成本/广告服务成本",     "损益", "借"),
...
def auto_generate_purchase_journal(db, company_id, invoice_id=None):
    ...
    for code, name in _MAIN_BIZ_COST_DETAIL.values():
