...
(function () {
  ...
  function methodologyCss() {
    return [
      ...
      '.m3-nav>b{display:block;margin:0 20px 16px;color:var(--brand);font-size:10px;font-weight:800;letter-spacing:.08em}',
      ...
      // ── 正文阅读区：白底居中、宽松内边距 ──
      '.m3-prose{min-width:0;flex:1;max-width:1000px;margin:0 auto;background:#fff;padding:36px 48px 48px;border:1px solid var(--line);border-radius:16px;box-shadow:0 8px 32px rgba(7,31,74,.05)}',
      ...
      // ── 章节大标题：层级第一级 ──
      '.m3-prose h2{font-size:10px;font-weight:800;color:var(--ink);margin:0 0 18px;padding-bottom:10px;border-bottom:2px solid var(--brand);letter-spacing:.02em}',
      '.m3-prose h2 small{display:block;margin-top:5px;font-size:10px;font-weight:500;color:var(--muted);letter-spacing:0}',
      // ── 小节标题：层级第二级 ──
      '.m3-prose h4{margin:22px 0 12px;padding-left:14px;border-left:3px solid var(--brand);font-size:10px;font-weight:700;color:var(--brand)}',
      '.m3-prose h5.m3-scene-title{margin:0 0 12px;padding:0 0 8px;border-bottom:1px solid var(--line);font-size:10px;font-weight:700;color:var(--ink);display:flex;align-items:baseline;gap:12px;text-indent:0}',
      '.m3-prose h5.m3-scene-title b{padding:2px 8px;border-radius:4px;background:#fdf5f6;color:var(--brand);font-size:10px;font-weight:800;letter-spacing:.05em}',
      '.m3-prose h5.m3-scene-title span{flex:1;line-height:1.6}',
      // ── 正文段落：首行缩进、两端对齐 ──
      '.m3-prose p{margin:0 0 16px;font-size:10px;line-height:1.6;color:#242b3a;text-align:justify;text-justify:inter-ideograph;text-indent:2em}',
      '.m3-prose p:first-child{text-indent:0}',
      '.m3-prose p b{color:#8b2332;font-weight:700}',
      // ── 段落式实体（原实体卡改段落）：编号+名称+描述连续成段 ──
      '.m3-prose p.m3-entity-prose{margin:0 0 12px;padding:0 0 12px;border-bottom:1px dashed var(--line);font-size:10px;line-height:1.6;text-indent:0}',
      '.m3-prose .m3-entity-code{display:inline-block;min-width:80px;margin-right:8px;padding:2px 8px;border-radius:4px;background:var(--soft);color:var(--brand);font-size:10px;font-weight:800;text-align:center}',
      '.m3-prose .m3-entity-name{margin-right:8px;font-size:10px;color:var(--ink)}',
      // ── 嵌入式引用指标 ──
      '.m3-prose .m3-ref{display:inline-block;margin:0 3px;padding:1px 9px;border:1px solid var(--line);border-radius:14px;background:var(--soft);font-size:10px;line-height:1.6;color:#3a4561}',
      '.m3-prose .m3-ref>b{margin-right:5px;color:var(--brand);font-weight:800;font-size:10px}',
      // ── 嵌入式列表：段落内要点 ──
      '.m3-prose .m3-inline-list{margin:8px 0 16px 24px;padding:0;text-indent:0}',
      '.m3-prose .m3-inline-list li{position:relative;margin:6px 0;font-size:10px;line-height:1.6;color:#39404f;list-style:none}',
      '.m3-prose .m3-inline-list li:before{content:"·";position:absolute;left:-16px;color:var(--brand);font-weight:800}',
      // ── 引用盒：原则/边界陈述 ──
      '.m3-prose .m3-quote,.m3-prose .m3-coda{margin:16px 0 20px;padding:12px 20px;border-left:3px solid var(--brand);background:#fdf5f6;border-radius:0 8px 8px 0;font-size:10px;line-height:1.6;color:#3d4659;text-indent:0}',
      '.m3-prose .m3-quote>b{display:block;margin-bottom:6px;color:var(--brand);font-size:10px;font-weight:800;letter-spacing:.06em}',
      // ── 表格：自适应宽度、字号适中 ──
      ...
      '.m3-prose .m3-table-wrap table{width:100%;border-collapse:collapse;font-size:10px}',
      '.m3-prose .m3-table-wrap th{padding:10px 14px;background:var(--soft);color:#475569;text-align:left;font-weight:700;font-size:10px;letter-spacing:.03em}',
      '.m3-prose .m3-table-wrap td{padding:10px 14px;border-top:1px solid #eef1f5;vertical-align:top;font-size:10px;line-height:1.6}',
      ...
      '.m3-prose .m3-fold>summary{display:flex;justify-content:space-between;gap:14px;align-items:center;padding:12px 20px;cursor:pointer;list-style:none;font-size:10px;font-weight:600;color:var(--ink)}',
      '.m3-prose .m3-fold>summary::-webkit-details-marker{display:none}',
      '.m3-prose .m3-fold>summary b{display:inline-block;min-width:60px;margin-right:10px;padding:2px 8px;border-radius:4px;background:#fdf5f6;color:var(--brand);font-size:10px;font-weight:800;letter-spacing:.05em;text-align:center}',
      '.m3-prose .m3-fold>summary em{color:var(--muted);font-size:10px;font-style:normal;text-align:right}',
      ...
      '.m3-prose .m3-scene p{margin:0 0 12px;font-size:10px;line-height:1.6;text-align:justify}',
      ...
      '.m3-prose .m3-obs li{display:flex;align-items:baseline;gap:12px;padding:9px 0;border-bottom:1px dashed var(--line);font-size:10px;color:#39404f}',
      '.m3-prose .m3-obs li:last-child{border-bottom:0}',
      '.m3-prose .m3-obs li>b{flex:none;color:var(--brand);font-size:10px;font-weight:800;min-width:64px;text-align:right}',
      ...
      '.m3-prose .m3-empty p{margin:8px 0 0;color:var(--muted);font-size:10px;text-align:center;text-indent:0}',
      // ── 响应式 ──
      '@media(max-width:1100px){.m3-nav{display:none}.m3-prose{padding:28px 30px}}',
      '@media(max-width:720px){.m3-prose{padding:22px 18px;font-size:10px}.m3-prose section{margin-bottom:36px;padding-bottom:22px}.m3-prose p{font-size:10px;text-indent:0}.m3-prose .m3-fold>summary{display:block}.m3-prose .m3-fold>summary em{display:block;margin-top:8px;text-align:left}}'
    ].join('');
  }
