...
(function () {
  ...
  function methodologyCss() {
    return [
      ...
      '.m3-nav>b{display:block;margin:0 20px 16px;color:var(--brand);font-size:14px;font-weight:800;letter-spacing:.08em}',
      '.m3-nav a{display:block;padding:9px 20px;border-left:3px solid transparent;color:#5c6675;text-decoration:none;font-size:13px;font-weight:500;transition:all .15s}',
      ...
      // ── 章节大标题：层级第一级 ──
      '.m3-prose h2{font-size:19px;font-weight:800;color:var(--ink);margin:0 0 18px;padding-bottom:10px;border-bottom:2px solid var(--brand);letter-spacing:.02em}',
      '.m3-prose h2 small{display:block;margin-top:5px;font-size:13px;font-weight:500;color:var(--muted);letter-spacing:0}',
      // ── 小节标题：层级第二级 ──
      '.m3-prose h4{margin:22px 0 12px;padding-left:14px;border-left:3px solid var(--brand);font-size:16px;font-weight:700;color:var(--brand)}',
      '.m3-prose h5.m3-scene-title{margin:0 0 12px;padding:0 0 8px;border-bottom:1px solid var(--line);font-size:15.5px;font-weight:700;color:var(--ink);display:flex;align-items:baseline;gap:12px;text-indent:0}',
      ...
      // ── 正文段落：首行缩进、两端对齐 ──
      '.m3-prose p{margin:0 0 16px;font-size:15px;line-height:1.9;color:#242b3a;text-align:justify;text-justify:inter-ideograph;text-indent:2em}',
      '.m3-prose p:first-child{text-indent:0}',
      '.m3-prose p b{color:#8b2332;font-weight:700}',
      // ── 段落式实体（原实体卡改段落）：编号+名称+描述连续成段 ──
      '.m3-prose p.m3-entity-prose{margin:0 0 12px;padding:0 0 12px;border-bottom:1px dashed var(--line);font-size:14.5px;line-height:1.85;text-indent:0}',
      ...
      '.m3-prose .m3-entity-name{margin-right:8px;font-size:14.5px;color:var(--ink)}',
      // ── 嵌入式引用指标 ──
      '.m3-prose .m3-ref{display:inline-block;margin:0 3px;padding:1px 9px;border:1px solid var(--line);border-radius:14px;background:var(--soft);font-size:13px;line-height:1.7;color:#3a4561}',
      '.m3-prose .m3-ref>b{margin-right:5px;color:var(--brand);font-weight:800;font-size:13.5px}',
      // ── 嵌入式列表：段落内要点 ──
      '.m3-prose .m3-inline-list{margin:8px 0 16px 24px;padding:0;text-indent:0}',
      '.m3-prose .m3-inline-list li{position:relative;margin:6px 0;font-size:14.5px;line-height:1.85;color:#39404f;list-style:none}',
      '.m3-prose .m3-inline-list li:before{content:"·";position:absolute;left:-16px;color:var(--brand);font-weight:800}',
      // ── 引用盒：原则/边界陈述 ──
      '.m3-prose .m3-quote,.m3-prose .m3-coda{margin:16px 0 20px;padding:12px 20px;border-left:3px solid var(--brand);background:#fdf5f6;border-radius:0 8px 8px 0;font-size:14.5px;line-height:1.9;color:#3d4659;text-indent:0}',
      '.m3-prose .m3-quote>b{display:block;margin-bottom:6px;color:var(--brand);font-size:12.5px;font-weight:800;letter-spacing:.06em}',
      // ── 表格：自适应宽度、字号适中 ──
      ...
      '.m3-prose .m3-table-wrap table{width:100%;border-collapse:collapse;font-size:13.5px}',
      '.m3-prose .m3-table-wrap th{padding:10px 14px;background:var(--soft);color:#475569;text-align:left;font-weight:700;font-size:13px;letter-spacing:.03em}',
      '.m3-prose .m3-table-wrap td{padding:10px 14px;border-top:1px solid #eef1f5;vertical-align:top;font-size:13.5px;line-height:1.75}',
      ...
      '.m3-prose .m3-fold>summary{display:flex;justify-content:space-between;gap:14px;align-items:center;padding:12px 20px;cursor:pointer;list-style:none;font-size:14.5px;font-weight:600;color:var(--ink)}',
      ...
      '.m3-prose .m3-scene p{margin:0 0 12px;font-size:14.5px;line-height:1.9;text-align:justify}',
      ...
      '.m3-prose .m3-obs li{display:flex;align-items:baseline;gap:12px;padding:9px 0;border-bottom:1px dashed var(--line);font-size:14px;color:#39404f}',
      '.m3-prose .m3-obs li:last-child{border-bottom:0}',
      '.m3-prose .m3-obs li>b{flex:none;color:var(--brand);font-size:17px;font-weight:800;min-width:64px;text-align:right}',
      ...
      '@media(max-width:720px){.m3-prose{padding:22px 18px;font-size:14.5px}.m3-prose section{margin-bottom:36px;padding-bottom:22px}.m3-prose p{font-size:14.5px;text-indent:0}.m3-prose .m3-fold>summary{display:block}.m3-prose .m3-fold>summary em{display:block;margin-top:8px;text-align:left}}'
    ].join('');
  }
