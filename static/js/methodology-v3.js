(function () {
  ...
  function methodologyCss() {
    return [
      ...
      '.m3-main{min-width:0;flex:1}.m3-hero{padding:48px 52px 42px;border:1px solid #d5dae2;border-radius:16px;background:linear-gradient(135deg,#1a1a2e,#2c3a50);color:#fff;box-shadow:0 16px 36px rgba(26,26,46,.1)}.m3-hero>span{display:block;margin-bottom:8px;color:#d4a574;font-size:13px;font-weight:600;letter-spacing:.1em;text-transform:uppercase}.m3-hero h1{max-width:900px;margin:0 0 16px;color:#fff;font-size:34px;line-height:1.35;letter-spacing:-.03em;font-weight:800}.m3-hero p{max-width:1100px;margin:0;color:#c8d2de;font-size:16px;line-height:2.1}.m3-flow{display:flex;flex-wrap:wrap;align-items:center;gap:10px;margin-top:28px}.m3-flow b{padding:7px 12px;border:1px solid rgba(255,255,255,.2);border-radius:6px;background:rgba(255,255,255,.1);font-size:12px;font-weight:600}.m3-flow i{color:var(--accent);font-size:14px;font-style:normal;font-weight:700}',
