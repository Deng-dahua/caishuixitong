...
(function () {
  ...
  function methodologyCss() {
    return [
      ...
      // ── 正文阅读区：白底居中、宽松内边距 ──
      '.m3-prose{min-width:0;flex:1;max-width:1500px;margin:0 30px 0 30px;background:#fff;padding:36px 48px 48px;border:1px solid var(--line);border-radius:16px;box-shadow:0 8px 32px rgba(7,31,74,.05)}',
