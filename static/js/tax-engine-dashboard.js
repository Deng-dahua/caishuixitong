...
function renderNegotiationTab() {
  ...
  var rules = [
    ...
    {id:'NEG-050',scene:'消解层扩展',action:'消解',from:'行业判定→"服务行业"',to:'制造业成本(BOM/进销存/加工费)',desc:'企业判定为服务行业，制造业成本分析不适用，直接消解。'},
    {id:'NEG-051',scene:'消解层扩展',action:'消解',from:'行业判定→"个体工商户"',to:'企业所得税相关发现',desc:'个体工商户不缴纳企业所得税，相关风险标记不适用。'},
    {id:'NEG-052',scene:'消解层扩展',action:'消解',from:'行业判定→"小规模纳税人"',to:'进项税额异常',desc:'小规模纳税人不抵扣进项税额，进项税额异常标记不适用。'},
    {id:'NEG-060',scene:'降级层扩展',action:'降级',from:'收款与开票金额偏差',to:'隐匿收入',desc:'收款偏差可能含非经营收款（注资/借款/税费返还），降为中风险，需逐笔核对方可升级。'},
    {id:'NEG-061',scene:'降级层扩展',action:'降级',from:'付款与进项金额偏差',to:'虚列成本',desc:'付款偏差可能含投资/往来款/借款等非采购付款，降为中风险，需逐笔核对方可升级。'},
    {id:'NEG-062',scene:'降级层扩展',action:'消解',from:'经营实质域→"检测到经营费用"',to:'"无实际经营"结论',desc:'经营实质域已检测到水电/物业/租金/通信/物流费用，企业存在实际经营活动，直接消解。'},
    {id:'NEG-063',scene:'降级层扩展',action:'降级',from:'银行流水',to:'增值税申报销售额偏差',desc:'银行流水含股东注资/借款/往来款/退款等非应税收入，降为低风险。与增值税申报表口径不一致。'},
