...
function renderSystemLogsTable(logs, filter) {
  ...
  var html = '<table style="width:100%;border-collapse:collapse;font-size:13px">'
    ...
    + '<th style="padding:8px 12px;font-weight:600;color:#0f172a">公司</th>'
  ...
  logs.forEach(function(l) {
    ...
    html += '<tr style="border-bottom:1px solid #f1f5f9">'
      ...
      + '<td style="padding:8px 12px;max-width:240px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#64748b" title="' + escLog(l.path) + '">' + escLog(l.path.replace('/api/','')) + '</td>'
      + '<td style="padding:8px 12px;max-width:140px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#0f172a;font-weight:500" title="' + escLog(l.company_name || '') + '">' + (l.company_name ? escLog(l.company_name.substring(0,12)) : '<span style="color:#94a3b8">-</span>') + '</td>'
