...
async function renderCulturalConstructionFee(container) {
  ...
  el.innerHTML = '<div class="card card-fill"><div id="ccf-stats-row" style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:16px"></div>'
...
function renderCCFStats(forcePeriod) {
  ...
  if (ccfCurrentData) {
    ...
    var row10 = main.row10_payable_fee_current || 0;
    var row18 = main.row18_fill_refund_current || 0;
    var periodLabel = ccfCurrentData.period || '';
