...
function renderMethodologyPart2(){
  ...
  h+='<details style="margin-bottom:8px"><summary style="font-size:13px;font-weight:700;color:#16233a;cursor:pointer;padding:6px 0">🔒 证据链数据（可直接查阅全部验证维度）</summary><div class="live"><div id="au-evidence-data"></div></div></details><details style="margin-bottom:8px"><summary style="font-size:13px;font-weight:700;color:#16233a;cursor:pointer;padding:6px 0">📊 域分析发现（各域实际检出结果）</summary><div class="live"><div id="au-domain-result"></div></div></details><details style="margin-bottom:8px"><summary style="font-size:13px;font-weight:700;color:#16233a;cursor:pointer;padding:6px 0">🔀 跨域分析链（48条综合推理路径）</summary><div class="live"><div id="au-analysis-chains"></div></div></details><details style="margin-bottom:8px"><summary style="font-size:13px;font-weight:700;color:#16233a;cursor:pointer;padding:6px 0">🗂️ 域分析详情（{{domain_functions}}个域的功能与数据要求）</summary><div class="live"><div id="au-da-domains"></div></div></details><details style="margin-bottom:8px"><summary style="font-size:13px;font-weight:700;color:#16233a;cursor:pointer;padding:6px 0">🤖 自动发现规则（引擎从数据中自学习的信号）</summary><p style="font-size:11px;color:#64748b;margin:4px 0 8px">以下规则由引擎在分析过程中自动发现——包括行业基准自动校准和信号模式识别。置信度和发生率显示每条发现的可靠程度。<em>自动发现规则不替代人工规则，建议人工审核后升级。</em></p><div class="live"><div id="au-auto-rules"><div style="font-size:11px;color:#64748b;margin-bottom:8px">共 15 条自动发现规则</div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1599</b> 行业基准校准: 设计服务 <span style="color:#94a3b8;font-size:10px">行业专项</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：行业基准校准: 设计服务。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：行业基准=税务机关的第一参照系】税务机关内部有覆盖全行业的税负率、利润率、费用率基准数据库。你的数据一旦偏离基准3个标准差以上，系统自动标红——你还没见到稽查员，系统已经知道你有问题。【推理第二层：设计服务行业的特殊性】设计服务属于轻资产行业，核心成本是人力，毛利率天然偏高（60%-80%是正常区间）。毛利率异常偏低=要么收入少报了、要么成本多列了、要么虚增了人员工资或外包费用。【推</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1600</b> 行业基准校准: 综合 <span style="color:#94a3b8;font-size:10px">行业专项</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：行业基准校准: 综合。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：综合性行业基准校准的全局视角】综合分类意味着企业跨多个行业经营——这种企业的税务风险不是单点风险，而是多点叠加的复合风险。不同行业的税负率基准不同——如果每个行业板块都偏离基准，问题比单一行业偏离严重得多。【推理第二层：为什么综合类企业更容易出问题】多行业经营=多个收入确认时点、多种成本归集方式、多档税率适用——复杂度本身就是风险的温床。会计能不能正确拆分各行业收入？能不能正确分摊共</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1601</b> [饲料] 购销严重倒挂 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[饲料] 购销严重倒挂。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：购销倒挂=商业逻辑的彻底崩塌】采购价高于销售价=卖一单亏一单。没有企业能长期亏本经营——要么是短期促销策略、要么是账面数字造假。饲料行业利润薄、竞争烈，购销倒挂的概率理论上更小——因为饲料企业不可能接受长期亏本。【推理第二层：饲料行业的特殊性】饲料行业涉及大量农产品采购（玉米、豆粕等），农产品发票是虚开重灾区。购销倒挂+农产品采购=极高可能性在虚构采购成本——采购发票金额被虚增，使得</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1602</b> [饲料] 毛利为负 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[饲料] 毛利为负。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：毛利为负=企业正在失血】毛利=销售收入-销售成本。毛利为负意味着卖产品收的钱还不够覆盖最基本的采购/生产成本——连原材料/进货的钱都没赚回来。这种情况如果持续发生——企业要么在烧钱换市场（烧不了多久）、要么账面数字有问题。【推理第二层：饲料行业负毛利的两种解释】合法解释：市场行情剧烈下跌+高价位库存被迫低价出售（一次性的）。非法解释：①采购端虚增成本（让账面毛利变负）——如果虚增进项</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1603</b> [饲料] 缺少银行流水 <span style="color:#94a3b8;font-size:10px">资金流</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[饲料] 缺少银行流水。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：银行流水=企业经营的生命线证据】在电子支付全面普及的当下，企业的采购付款和销售收款几乎必然产生银行流水。缺少银行流水=要么交易本身不存在（虚假交易）、要么刻意不走对公账户（隐匿交易）。无论是哪种——都是致命问题。【推理第二层：饲料行业缺少银行流水的特别含义】饲料行业采购对象多为个体农户（售粮人）——农户天然偏好现金交易。但规范经营的饲料企业在采购大宗农产品时，必须通过对公账户向售粮人</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1604</b> 行业基准校准: 饲料 <span style="color:#94a3b8;font-size:10px">行业专项</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：行业基准校准: 饲料。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：饲料行业的低毛利特性】饲料行业是典型的薄利多销行业——正常毛利率在5%-15%之间。但这不代表没有基准可参照——行业税负率、费用率、增值税贡献率等指标仍旧可以精确衡量企业是否异常。【推理第二层：饲料企业偏离基准的常见手法】毛利率低于行业基准——可能隐匿销售收入（未经加工直接倒卖原料不计收入）或虚增进项（多开农产品收购发票）。费用率高于行业基准——可能虚列运输费（把私车费用入账）、虚列</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1605</b> 行业基准校准: 现代服务 <span style="color:#94a3b8;font-size:10px">行业专项</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：行业基准校准: 现代服务。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：现代服务业的低税负诱惑】现代服务业适用6%增值税税率，远低于货物销售的13%——这本身就吸引了一些企业将货物销售包装成现代服务以套取低税率。行业基准校准的目的正是识别这种滥用。【推理第二层：现代服务业的轻资产特征】现代服务业核心资产是人脑而不是设备。成本结构中人工费占大头（60%-80%），物耗极少。如果一家现代服务企业的物耗占比异常偏高——要么是混合销售未拆分、要么是把货物采购伪装</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1606</b> 行业基准校准: 信息技术服务 <span style="color:#94a3b8;font-size:10px">行业专项</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：行业基准校准: 信息技术服务。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：信息技术服务的税收优惠陷阱】信息技术服务业既是现代服务业（6%增值税），又是高新技术企业/软件企业的重点认定领域——可享受企业所得税15%优惠税率和软件产品即征即退。多重优惠叠加后，企业实际税负可能低到个位数——这是合法的。但不符合条件的企业冒充享受优惠=偷税。【推理第二层：高薪行业的人均产值作弊风险】信息技术服务业人均产值通常较高（30-80万/人/年）。如果人均产值异常偏低——要</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1607</b> 行业基准校准: 广告服务 <span style="color:#94a3b8;font-size:10px">行业专项</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：行业基准校准: 广告服务。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：广告服务的双重纳税义务】广告服务业不仅要缴6%增值税，还要缴3%文化事业建设费（按含税广告收入）。两项合计=9%的流转税负担——远高于普通服务业6%。这种高税负天然会驱动企业——隐匿广告收入以逃避文建费。【推理第二层：文化事业建设费的逃费手法】最常见的手法：将广告收入包装成策划费/设计费/咨询费以规避3%文建费（只缴6%增值税）；将广告位出租收入与广告发布收入混淆（广告位出租只缴增值</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1608</b> [设计服务] 购销严重倒挂 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[设计服务] 购销严重倒挂。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：设计服务购销倒挂的异常信号】设计服务属于服务业，没有传统意义上的商品购销——购销倒挂在服务业中的含义不同。实务中，设计服务企业可能涉及外包设计、购买设计方案、采购设计素材等成本。当这些采购成本异常高于设计收入时→购销倒挂信号触发。【推理第二层：设计服务倒挂的三种解释】合法解释：承接了大型亏损项目（长期合同但报价低估）；外包了大量高端设计工作但客户未接受报价导致回款不足；一次性采购了大</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1609</b> [设计服务] 毛利为负 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[设计服务] 毛利为负。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：设计服务负毛利的统计异常】设计服务是轻资产高毛利行业——正常毛利率50%-80%。如果设计服务毛利为负——说明账面数据显示：设计人员的工资+外包费+素材采购费 > 设计服务收入。这在商业上意味着：每接一个设计项目都在亏钱。没有企业能持续亏本做设计。【推理第二层：设计服务负毛利的非商业原因】如果企业声称亏本——要么是在为关联方低价提供设计服务（转移利润到低税率关联方）、要么收入被人为压</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1610</b> [广告服务] 购销严重倒挂 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[广告服务] 购销严重倒挂。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：广告服务购销倒挂的表象与实质】广告服务企业的\'采购\'主要是媒体投放费（购买广告位/时段/流量）和外发制作费。当媒体投放费+制作费 > 广告服务收入——账面显示广告公司在倒贴钱帮客户投广告。这在商业上不可能——广告公司是赚取媒体差价和制作费的中间商，不可能长期承担亏损。【推理第二层：广告购销倒挂的逃税逻辑】如果广告公司账面显示采购高于收入——要么收入被隐匿（收取广告主的现金或私户转款不</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1611</b> [广告服务] 毛利为负 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[广告服务] 毛利为负。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：广告服务负毛利的多重逃税动机】广告服务毛利为负有两个可能的逃税方向：一是隐匿广告收入（收现金或私户不报）让收入看起来低于成本；二是虚增媒体采购成本（虚开采购发票）让成本看起来高于收入。两种手法可能单独使用，也可能同时使用。【推理第二层：广告负毛利+文建费的逃费逻辑】文化事业建设费按含税广告收入的3%征收。如果广告公司隐匿广告收入——不仅逃了增值税和所得税，还逃了3%文建费。而虚增媒体</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1612</b> [信息技术服务] 购销严重倒挂 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[信息技术服务] 购销严重倒挂。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：信息技术服务购销倒挂的独特性】IT服务企业的\'购销倒挂\'主要体现在：外包开发费、服务器/云服务采购费、第三方软件授权费超过IT服务收入。这意味着账面显示——IT公司花了100万请外包团队做项目，但只收了80万的服务费。这在行业里叫\'贴钱做项目\'——不可能持续。【推理第二层：IT外包虚增的双重逃税】IT企业最常见的操作：将大量开发工作外包给关联方（或虚构的外包方），以高价外包费拉高成本</div></div><div style="padding:10px 14px;margin:4px 0;background:#fff;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:4px;font-size:12px"><b>#1613</b> [信息技术服务] 毛利为负 <span style="color:#94a3b8;font-size:10px">发票进销匹配</span><div style="margin:4px 0;color:#475569;font-size:11px">系统自动发现的异常信号：[信息技术服务] 毛利为负。常见表现：①该异常信号在本次分析的业务数据中被重复识别②信号强度通过多维度交叉验证后达到置信度阈值③与同行业基准数据对比存在显著偏离④该信号在历史分析记录中持续出现，可能构成系统性风险</div><div style="margin:2px 0;color:#64748b;font-size:11px">【推理第一层：IT服务负毛利的行业矛盾】IT服务业是高附加值行业——正常毛利率在30%-60%。IT服务毛利为负——在行业内极度罕见。这要么意味着企业的项目管理和成本控制出现了灾难性问题、要么意味着财务数据存在严重不实。【推理第二层：IT负毛利的逃税三路径】路径A——隐匿IT服务收入：收现金或私户不报，让账面收入远低于实际收入。路径B——虚增外包开发成本：与关联方串通，以高额外包费虚增成本。路径C</div></div></div></div></details></div>';
