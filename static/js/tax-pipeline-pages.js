...
function renderQualitySystem(container) {
  ...
  var layers = [
    ...
    },
    {
      ...
      items: [
        {name:'稽查方法论㉖条', source:'main.py (各域分析函数 + _run_analyze)',
        ...
        {name:'四步稽查分析法', source:'main.py (detect→verify→diagnose→report 管线)',
        ...
        {name:'三层行业穿透法', source:'main.py (_detect_target_entity + _online_company_lookup)',
        ...
        {name:'经营实质点面推理法', source:'main.py (_domain_fund_flow + _analyze_geo_business_premise)',
        ...
        {name:'合同分层判断法', source:'main.py (_analyze_contract_tiers)',
        ...
        {name:'发票≠收付款1:1方法论', source:'main.py (_domain_fund_flow + generate_report.py)',
    ...
    },
    {
      ...
      items: [
        {name:'稽查重点强制等级', source:'main.py (_fix_level_by_audit_priority)',
        ...
        {name:'报告纯净度规范', source:'generate_report.py (报告输出清洗)',
        ...
        {name:'方法论噪声过滤器', source:'main.py (_methodology_filter)',
    ...
    },
    {
      ...
      items: [
        {name:'25行业产品链词典', source:'main.py (INDUSTRY_PRODUCT_CHAINS 字典)',
        ...
        {name:'外包轻加工模式认知', source:'main.py (行业认知硬编码规则)',
        ...
        {name:'66行业基准值库', source:'main.py (INDUSTRY_BENCHMARKS 字典)',
    ...
    },
    {
      ...
      items: [
        {name:'七步执行流程', source:'main.py (_run_analyze 函数, 约第8540行)',
        ...
        {name:'35个域分析函数', source:'main.py (_domain_* 各域分析函数)',
        ...
        {name:'全链路溯源体系', source:'tax-doc-analysis.js (renderTaxDocReport) + main.py',
