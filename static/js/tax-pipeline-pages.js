...
function renderAnalyzeResult(report) {
  ...
  var methods = [
    ...
    {id:'⑥', name:'联网核查（报告第一章强制要求）', desc:'稽查报告第一章「案件来源及稽查对象基本情况」必须调用_ online_company_lookup()获取：法定代表人/注册资本/经营范围/行业代码/股东信息/登记状态。如果联网核查失败，报告中必须注明"联网核查未成功，信息来源于发票数据推断"。代码：main.py:18428 _online_company_lookup()。'},
