...
function renderMethodologyAssemble(){
  ...
  if(ar&&typeof renderTaxRiskRules==='function'){try{renderTaxRiskRules(ar); setTimeout(function(){var sf=document.getElementById('rr-src-filter');if(sf){sf.value='系统发现';window._rrFilter&&window._rrFilter();}},500);}catch(e){ar.innerHTML='<span style="color:#94a3b8">自动发现规则加载中...</span>'}}
