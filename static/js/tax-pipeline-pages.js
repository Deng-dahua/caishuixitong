...
function renderMethodologyAssemble(){
  ...
  if(ar){ar.innerHTML='<div style="text-align:center;padding:24px;color:#94a3b8">加载中...</div>';fetch('/static/auto_rules_snippet.html?'+Date.now()).then(function(r){return r.text()}).then(function(h){ar.innerHTML=h}).catch(function(e){ar.innerHTML='<span style="color:#dc2626">加载失败:'+e.message+'</span>'})}
