...
function renderTaxRiskRules(container) {
  ...
  h += '<details id="rr-standard" style="margin-bottom:16px;background:#fafbfc;border:1px solid #eef2f6;border-radius:8px;padding:12px 16px;font-size:12px;line-height:1.9;color:#334155" open><summary style="font-weight:700;color:#16233a;cursor:pointer;font-size:13px">📐 精写编制标准（23字段完整版 · v3穷举至稽查终点）</summary>'
    ...
    + '<b>⑦ policy_ref（法律依据）：</b>引用<b>现行有效</b>的法律法规——统一冠以“现行有效的《XX法》(版本)第X条”，保留条号保证稽查精确性。法律不写死、不当永久真理：每条引用须过<b>法律时效性核查程序</b>(engine/law_validity_checker，已接入审计)验证，末尾强制附核验日期。已废止对照：《增值税暂行条例》2026-01-01废止→《增值税法》(第2条税率→第9条/第6条销售额价外费用→第17条/第19条纳税义务时间→第28条)；营业税2016-05-01营改增废止；《会计法》标注2024修正。法律变动时只更新核查清单+重跑，自动标出需更新的规则。示例:现行有效的《增值税法》(2026-01-01施行)第十七条…（法规现行性核验：2026-07-13）<br>'
