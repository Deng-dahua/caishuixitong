...
function renderTaxRiskRules(container) {
  ...
  container.innerHTML = ''
    ...
    + '<div style="font-weight:700;font-size:13px;color:#1e293b;margin-bottom:8px">\u2466 \u52a8\u6001\u94fe\u89e6\u53d1 + \u7a3d\u67e5\u62a5\u544a</div>'
    + '<div style="font-size:11px;color:#64748b;line-height:1.8">'
    + '\u53d1\u73b0A\u2192\u5f15\u64ce\u81ea\u52a8\u63a8\u8350 B/C/D \u4e0b\u4e00\u6b65\u8c03\u67e5<br>'
    + '\u89e6\u53d1\u94fe\u6807\u6ce8\u5728\u7a3d\u67e5\u7ed3\u8bba\u4e0b\u65b9 + \u63a8\u8350\u4e0b\u4e00\u6b65\u8c03\u67e5<br>'
    + '\u8f93\u51fa\u516d\u6bb5\u5f0f\u7a3d\u67e5\u5ba1\u6838\u62a5\u544a + \u94fe\u4f7f\u7528\u7edf\u8ba1\u6301\u4e45\u5316'
    + '</div></div>'
    + '</div>'
    // 统计总览
