...
function renderTaxRiskRules(container) {
  ...
  h += '<details id="rr-standard" style="margin-bottom:10px;background:#fafbfc;border:1px solid #eef2f6;border-radius:8px;padding:10px;font-size:10px;line-height:20px;color:#334155"><summary style="font-weight:700;color:#16233a;cursor:pointer;font-size:10px">📐 精写编制标准（23字段完整版 · v3穷举至稽查终点）</summary>'
    ...
    + '<p style="margin-top:20px;padding-top:10px;border-top:2px solid #e2e8f0"><b>⚔️ 顶级精写方法论——三条攻击角度</b></p>'
    ...
    + '<p style="margin-top:20px;padding-top:10px;border-top:2px solid #e2e8f0"><b>✅ 十条自检清单——十勾全满即顶级精写</b></p>'
    + '<p>GS-1·矛盾一句话：数据矛盾点必须能用X vs Y——一句话说清。GS-2·推理至法条：每层标注依赖证据，最后一层落地到法条编号。GS-3·追问堵死物理极限：必须包含物理常识类追问。GS-4·三路径各有进入条件：单源/2源/≥3源不得笼统写。GS-5·证据四层命名贴合：首层必须贴合疑点类型，禁止全用货物流。GS-6·税负能算出具体数字：必须给出补税计算公式和金额区间。GS-7·触发含三色预警：黄/橙/红按严重度分档。GS-8·正常解释有最常见标注：合法解释中必须标注最常见解释。GS-9·核查动作含现场核查：≥3步含1项现场核查，物理验证优于纸面比对。GS-10·适用条件五维度：行业+资质+规模+时间+金额全覆。</p>'
    ...
    + '<p style="margin-top:20px;padding-top:10px;border-top:2px solid #e2e8f0"><b>📊 27条深度精写规则全景索引</b></p>'
