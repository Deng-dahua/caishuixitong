...
function renderTaxRiskRules(container) {
  ...
  container.innerHTML = ''
    ...
    + '<div style="font-weight:700;font-size:13px;color:#1e293b;margin-bottom:8px">\u2460 Phase1: \u8bc6\u522b\u5206\u6790\u5bf9\u8c61 + \u53d1\u7968\u65b9\u5411\u6821\u6b63</div>'
    + '<div style="font-size:11px;color:#64748b;line-height:1.8">'
    + '\u8fdb\u9879\u8d2d\u4e70\u65b9 \u2229 \u9500\u9879\u9500\u552e\u65b9 \u2192 \u786e\u5b9a\u4f01\u4e1a\u540d\u79f0<br>'
    + '\u6bcf\u5f20\u7968\u53cd\u63a8\u65b9\u5411\uff1a\u4f01\u4e1a\u5728\u8d2d\u4e70\u65b9\u2192\u8fdb\u9879 \uff5c \u5728\u9500\u552e\u65b9\u2192\u9500\u9879<br>'
    + '\u81ea\u52a8\u6821\u6b63\u8bef\u5224\u53d1\u7968\uff0c\u4e0d\u518d\u4f9d\u8d56\u6587\u4ef6\u540d\u731c\u65b9\u5411'
    + '</div></div>'
    // 子系统2
    ...
    + '<div style="font-weight:700;font-size:13px;color:#1e293b;margin-bottom:8px">\u2462 \u8bed\u4e49\u5217\u68c0\u6d4b</div>'
    + '<div style="font-size:11px;color:#64748b;line-height:1.8">'
    + '\u4e0d\u770b\u5217\u540d\u53eb\u4ec0\u4e48\uff0c\u770b\u5b83\u5c5e\u4e8e\u54ea\u4e2a\u8bed\u4e49\u7c7b\u522b<br>'
    + '\u201c\u672c\u671f\u6536\u5165\u201d\u2192 amount_col \u2192 salary \u5b57\u6bb5<br>'
    + '\u201c\u9500\u552e\u65b9\u7eb3\u7a0e\u4eba\u540d\u79f0\u201d\u2192 counterparty \u2192 seller \u5b57\u6bb5<br>'
    + '\u8de8\u4f01\u4e1a\u683c\u5f0f\u901a\u914d\uff0c\u4e0d\u4f9d\u8d56\u56fa\u5b9a\u5217\u540d'
    + '</div></div>'
    // 子系统4
    ...
    + '<div style="font-weight:700;font-size:13px;color:#1e293b;margin-bottom:8px">\u2465 \u89c4\u5219+\u7ebf\u7d22\u94fe/\u8bc1\u636e\u94fe\u4e09\u5f15\u64ce</div>'
    + '<div style="font-size:11px;color:#64748b;line-height:1.8">'
    + 'tax_risk\u5f15\u64ce\u57df\u5206\u6790 + 382\u7ebf\u7d22\u94fe\u9010\u6b65\u9a71\u52a8\u68c0\u67e5<br>'
    + '735\u8bc1\u636e\u94fe\u95ed\u73af\u68c0\u6d4b\u2192\u226560%\u89e6\u53d1\u81ea\u52a8\u5224\u5b9a\u8fdd\u6cd5\u4e8b\u5b9e\u95ed\u73af<br>'
    + '\u5408\u540c/\u8fdb\u9500\u5b58/\u5173\u8054\u4ea4\u6613/\u79d1\u76ee\u4f59\u989d\u83dc\u5f15\u64ce\u540c\u6b65\u6267\u884c'
    + '</div></div>'
    // 子系统7
    + '<div style="border:1px solid #e2e8f0;border-left:3px solid #0891b2;border-radius:6px;padding:14px;background:#fff">'
    + '<div style="font-weight:700;font-size:13px;color:#1e293b;margin-bottom:8px">\u2466 \u7a3d\u67e5\u5ba1\u6838\u62a5\u544a\u8f93\u51fa</div>'
    + '<div style="font-size:11px;color:#64748b;line-height:1.8">'
    + '\u94fe\u6267\u884c\u62a5\u544a + \u8bc1\u636e\u95ed\u73af\u62a5\u544a + \u52a8\u6001\u63a8\u8350<br>'
    + '\u516d\u6bb5\u5f0f\u7a3d\u67e5\u5ba1\u6838\u62a5\u544a + \u94fe\u4f7f\u7528\u7edf\u8ba1\u6301\u4e45\u5316<br>'
    + '\u6240\u6709\u89c4\u5219/\u7ebf\u7d22\u94fe/\u8bc1\u636e\u94fe\u5168\u90e8\u6267\u884c\u5230\u4f4d'
    + '</div></div>'
    + '</div>'
    // 统计总览
