    ...
    fetch('/api/tax-risk-docs/report-smart?company_id=' + cid)
      ...
      .then(function(smart){
        ...
        if (smart.narrative) {
          ...
          smartHtml += '<span class="edt-icon edt-block-icon" onclick="event.stopPropagation();window._editScope={level:\'block\',id:\'block-narrative\',title:\'引擎智能分析总览\',content:\'' + (smart.narrative||'').replace(/'/g,"\\'") + '\'};window._unifiedEditPopup();window._edtBlockNode=event.target.closest(\x27.edt-block\x27);" title="编辑/审核/追问/重置" style="font-size:14px;cursor:pointer;opacity:0.35;transition:opacity 0.2s;margin-left:4px;flex-shrink:0;line-height:1.85">✏️</span>';
        ...
        if (smart.gap_chain && smart.gap_chain.length > 0) {
          ...
          smartHtml += '<span class="edt-icon edt-block-icon" onclick="event.stopPropagation();window._editScope={level:\'block\',id:\'block-gap\',title:\'资料缺口影响链\',content:\'资料缺口影响链：' + smart.gap_chain.map(function(g){return g.material;}).join('、') + '等资料缺失\'};window._unifiedEditPopup();window._edtBlockNode=event.target.closest(\x27.edt-block\x27);" title="编辑/审核/追问/重置" style="font-size:14px;cursor:pointer;opacity:0.35;transition:opacity 0.2s;margin-left:4px;flex-shrink:0;line-height:1.85">✏️</span>';
        ...
        if (smart.agi_enhanced && smart.agi_enhanced.meta_audit) {
          ...
          smartHtml += '<span class="edt-icon edt-block-icon" onclick="event.stopPropagation();window._editScope={level:\'block\',id:\'block-audit\',title:\'AGI自审报告\',content:\'' + auditSummary.replace(/'/g,"\\'") + '\'};window._unifiedEditPopup();window._edtBlockNode=event.target.closest(\x27.edt-block\x27);" title="编辑/审核/追问/重置" style="font-size:14px;cursor:pointer;opacity:0.35;transition:opacity 0.2s;margin-left:4px;flex-shrink:0;line-height:1.85">✏️</span>';
