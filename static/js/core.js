...
async function renderAgiDashboard(container) {
  ...
  try {
    ...
    h += '<div class="hb-info-card hb-info-purple"><strong>🔗 线索/证据链</strong><p><code>cross_domain_clues.json</code> → <strong>0条</strong>(41可执行+1174方法论)</p><p>可执行链含触发关键词/调查步骤/关联规则ID；方法链含完整税务合规步骤和法规引用</p></div>';
