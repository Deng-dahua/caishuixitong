...
function renderReportStandards(container) {
  ...
  var h = '<style>'
    ...
    + '.rpt-flow span.act{background:#16233a;color:#fff}'
    ...
    + '.rpt-table td{padding:8px 12px;border-bottom:1px solid #eff2f6;vertical-align:top;font-size:12.5px;color:#3a4048}'
    + '.rpt-table th{padding:8px 12px;background:#fafbfc;text-align:left;font-weight:600;color:#64748b;font-size:11px;border-bottom:2px solid #16233a}'
