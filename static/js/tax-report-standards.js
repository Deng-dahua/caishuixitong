...
function renderReportStandards(container) {
  ...
  var h = '<style>'
    ...
    + '.rpt-ch-title{font-size:17px;font-weight:800;color:#16233a;margin:0 0 10px;line-height:1.35;display:flex;align-items:center;gap:10px}'
    + '.rpt-ch-title .cn{display:inline-flex;align-items:center;justify-content:center;min-width:28px;height:28px;background:#16233a;color:#fff;border-radius:6px;font-size:14px;font-weight:800}'
    + '.rpt-block{background:#fafbfc;border:1px solid #eff2f6;border-radius:8px;padding:13px 15px;margin:4px 0 14px;font-size:12.5px;line-height:2.0;color:#3a4048}'
    + '.rpt-block h4{font-size:12.5px;font-weight:700;color:#16233a;margin:18px 0 8px}'
    ...
    + '.rpt-flow{display:flex;flex-wrap:nowrap;gap:6px;align-items:center;margin:12px 0;font-size:12px;overflow-x:auto}'
    ...
    + '.rpt-table td{padding:8px 12px;border-bottom:1px solid #eff2f6;vertical-align:top;font-size:12.5px;color:#3a4048;line-height:1.85}'
    ...
    + '.rpt-table th{padding:8px 12px;background:#fafbfc;text-align:left;font-weight:600;color:#64748b;font-size:11px;border-bottom:2px solid #16233a;white-space:nowrap}'
    + '.rpt-rule{display:flex;gap:10px;align-items:flex-start;margin:6px 0;padding:10px 14px;background:#fafbfc;border-radius:6px;border-left:3px solid #e2e8f0;font-size:12.5px;line-height:1.95;color:#3a4048}'
    + '.rpt-rule .rn{font-size:12px;font-weight:800;color:#16233a;min-width:20px}'
    + '.rpt-rule .rc{font-size:12.5px;color:#3a4048;line-height:1.95}'
