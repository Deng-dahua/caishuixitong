...
function renderHumanLearningPage(container) {
  ...
  container.innerHTML =
    ...
    '<p class="hl-para">人类学习引擎是财税稽查系统的<strong>自我进化核心</strong>。当稽查员在资料风险分析报告中进行编辑纠正、审核确认或追问补充时，引擎不是简单地接受修改，而是模拟人类认知的12项能力，从纠正内容中提炼规则、验证真伪、发现关联、回测效果，最终形成可复用的知识沉淀。</p>' +
